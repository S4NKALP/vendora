...
from .models import User, Category, Product, Rating, Order, OrderItem, CartItem, Cart, Favorite
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'description', 'price', 'image', 'category', 'stock','color','size',
                  'category_name', 'average_rating', 'created_at']
        read_only_fields = ['id', 'created_at', 'category_name', 'average_rating']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'user', 'user_name', 'total_price', 'status', 'shipping_address', 
                  'created_at', 'order_items', 'items']
        read_only_fields = ['id', 'created_at', 'user_name', 'total_price', 'order_items']
